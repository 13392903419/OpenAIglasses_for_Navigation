...
- 📖 **[完整复现指南](REPRODUCTION_GUIDE_CN.md)** - 从零开始的详细步骤（推荐）
- ⚡ **[快速开始](QUICK_START.md)** - 5分钟快速了解和启动
- 📋 **[任务检查清单](CHECKLIST.md)** - 可打印的进度跟踪清单
- 🔧 **[ESP32编程教程](ESP32_TUTORIAL.md)** - ESP32硬件基础和编程入门
...
### 新手入门
- 📖 **[完整复现指南](REPRODUCTION_GUIDE_CN.md)** - 从零开始复现项目的详细步骤
  - 项目概述和系统架构
  - 完整的前置准备清单
  - 7个阶段的详细执行步骤
  - Git版本控制指南
...
- ⚡ **[快速开始指南](QUICK_START.md)** - 5分钟快速了解和启动项目
  - 最小化启动步骤
  - 快速测试方法
  - 常见问题速查
